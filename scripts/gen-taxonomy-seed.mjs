...
const UNIVERSE = {
  ...
  basic_materials: {
    ...
    "Fiber-Based Packaging - NA": [
      "Graphic Packaging",
      "International Paper",
      "Packaging Corporation of America",
      "Smurfit Westrock",
    ],
    "Fiber-Based Packaging - Europe": [
      "Billerud",
      "Mayr-Melnhof Karton",
      "Mondi",
      "Sappi",
...
const RADAR = {
  carveout: {
    in_market: [
      ...
      "Dow Polyurethanes",
      "FMC",
      "Ingevity Advanced Polymer Technologies",
      "Nutrien Brazilian Soybean Business",
      "Nutrien Phosphates",
      "Solvay Flurochemicals",
      "Total Styrene and Polystyrene Plant",
      "Trinseo",
      "AmSty",
    ],
    monitor_for_exit: [
      "Celanese Infraserv",
      "Celanese Teijin Films JV",
      "Hexion Versatic Acids",
      "Mosaic Brazil Assets",
      "Shell U.S. Chemical Assets",
    ],
    on_hold: [
      "Beaulieu International Group / Pinnacle Polymers",
      "Braskem U.S. Assets",
      "Cargill Deicing Salt",
      "Compass Minerals Arizona Chemical",
      "IDL Chemical",
      "Element Solutions",
      "HF Sinclair Lubricants and Specialties",
      "Invista Nylon 6,6 Plants",
      "Syngenta Group non Ag/crop business",
      "Shell Phenol A",
    ],
  },
  private_asset: {
...
lines.push(
  `-- §2.2 Chemicals deal radar (${cRows.length} companies) → companies + new_entry history`
);
...
console.log(
  `Universe: ${uRows.length} companies · Radar: ${cRows.length} deal companies`
);
